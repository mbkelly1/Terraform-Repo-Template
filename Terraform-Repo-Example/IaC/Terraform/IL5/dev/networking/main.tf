terraform {
  ...
  backend "azurerm" {
    ...
    container_name       = "aisdevtfstatenet"   # networking backend storage container
...
module "networking" {
  ...
  net_resource_group_name        = "ais-net-demo-d-rgp-01"    # Change environment specific variable 
