...
terraform {
  ...
  backend "azurerm" {
    ...
    container_name       = "aisprodtfstatenet"     # networking backend storage container
...
module "networking" {
  ...
  net_resource_group_name        = "ais-net-demo-p-rgp-01"    # Change environment specific variable 
